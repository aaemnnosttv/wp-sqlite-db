<?php
/**
 * This file must be placed in the directory wp-content/db.php.
...
//            if (isset($_SERVER['SERVER_SOFTWARE']) && stripos($_SERVER['SERVER_SOFTWARE'],
//                    'apache') !== false || isset($_SERVER['SERVER_SIGNATURE']) && stripos($_SERVER['SERVER_SIGNATURE'],
//                    'apache') !== false) {
//                ;// Your server is Apache. Nothing to do more.
//            } else {
//                $server_message = sprintf('Your webserver doesn\'t seem to be Apache. So the database directory access restriction by the .htaccess file may not function. We strongly recommend that you should restrict the access to the directory %s in some other way.',
//                    FQDBDIR);
